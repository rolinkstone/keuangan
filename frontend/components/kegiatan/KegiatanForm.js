...
const fetchPegawaiSuggestions = async () => {
    try {
        ...
        const possibleUrls = [
            'http://localhost:5000/api/keycloak/users/all-simple',
            '/api/keycloak/users/all-simple', // Relative URL (proxy)
            'http://127.0.0.1:5000/api/keycloak/users/all-simple',
            `${window.location.origin}/api/keycloak/users/all-simple` // Same origin
        ];
